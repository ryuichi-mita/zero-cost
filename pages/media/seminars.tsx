...
export default function SeminarsPage({ articles }: SeminarsPageProps) {
  return (
    <>
      <Head>
        <title>セミナー - MarkeShiten</title>
        <meta name="description" content="MarkeShitenのセミナー・イベント情報をお届けします。" />
      ...
      <main className="bg-gray-50 min-h-screen">
        <div className="bg-white border-b">
          <div className="container mx-auto px-4 py-12">
            <h1 className="text-3xl md:text-4xl font-bold text-gray-900 mb-3">セミナー</h1>
            <p className="text-gray-500 text-base">最新のセミナー・イベント情報をお届けします</p>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4 py-12">
          {articles.length > 0 ? (
            ...
            <div className="text-center py-24 text-gray-400">
              <p className="text-lg">セミナー情報はまだありません。</p>
            </div>
          )}
        </div>
      </main>
...
export const getStaticProps: GetStaticProps = async () => {
  const articles = await getArticlesByCategory('seminar');
