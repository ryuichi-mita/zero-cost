          ...
          <div className="prose prose-lg max-w-none space-y-8">
            <section>
              <p className="text-gray-600">
                株式会社サンプル（以下「当社」といいます。）は、当社が提供するサービス（以下「本サービス」といいます。）における、ユーザーの個人情報の取扱いについて、以下のとおりプライバシーポリシー（以下「本ポリシー」といいます。）を定めます。
              </p>
            </section>
            ...
            <section>
              ...
              <div className="bg-gray-50 p-6 rounded-lg">
                <p className="text-gray-700">
                  ...
                  個人情報保護管理者：代表取締役<br />
                  〒100-0001 東京都千代田区千代田1-1-1 サンプルビル 5F<br />
                  E-mail: privacy@example.com
                </p>
              </div>
            </section>

            <section className="text-right text-gray-600 text-sm mt-12">
              <p>以上</p>
              <p className="mt-2">2025年1月1日 制定</p>
            </section>
          </div>
        </div>
      </main>
